...
import { commitSessionIdCookie, createSessionRecord } from "@/utils/session.server";
...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  const participantId = await RecoveryTokenService.verifyRecoveryToken(params.token);
